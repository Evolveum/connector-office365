...
/**
 * Managed domain i.e. non federated
 * @author Paul Heaney
 *
 */
public class Office365ManagedDomain extends Office365Domain {

    public Office365ManagedDomain(String name) {
        super(name, Office365Domain.DOMAIN_TYPE_MANAGED);
    }
}
